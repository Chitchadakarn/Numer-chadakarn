...
class Bowh extends Component {
    ...
    compute = () => {
        ...
        var xreal = diff.evaluate(scope); //แทนค่าxลงในสมการที่ดิฟ
        console.log(xreal)
    ...
    return (
        ...
        <h2 class="font-h2">Bw o(h)</h2>
            ...
            <Input class="input" style={{width:"250px",mgargin:"1rem"}} name="H" onChange={this.input.bind(this)} placeholder="h" />                        
                ...
                <div>
                <Button style={{margin:"1rem"}} type="ghost" shape="round" size="large" onClick={this.compute.bind(this)}>Submit</Button>
